...
const MovieHero = () => {
  ...
  return (
    <>
      <div>
        {/* MobileAnd Tab Screen (i.e.) for small and medium screen size */}
        ...
        {/* Large Screen Size ((i.e.) for Laptop*/}
        <div className='relative hidden w-full lg:block' style={{ height: "28rem" }}>
          <div className="absolute z-10 w-full h-full" style={{ backgroundImage: "linear-gradient(90deg, rgb(34, 34, 34) 24.95%, rgb(34, 34, 34) 38.2%, rgba(34, 34, 34, 0.04) 97.47%, rgb(34, 34, 34) 100%) ", }} >
