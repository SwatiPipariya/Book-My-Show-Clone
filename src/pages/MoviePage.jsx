...
const MoviePage = () => {
  ...
  const [recommendedMovies, setRecommmendedMovies] = useState([]);
  ...
  useEffect(() => {
    const requestRecommendedMovies = async () => {
      ...
      setRecommmendedMovies(getRecommendedMovies.data.results);
    }
  ...
  <>
    ...
    <div className='my-12 container px-4 lg-ml-20 lg:w-2/1'>
      <div className='flex flex-col items-start gap-3'>
        <h1 className='text-gray-800 font-old gap-3 text-2xl'>About The Movie</h1>
        <p>{movie.overview}</p>
      </div>
      ...
      <div className='my-8'>
        ...
        <div className='flex flex-col gap-3 lg:flex-row lg:w-3/4'>
          ...
          <div className='flex items-start gap-2 bg-yellow-100 p-3 border-yellow-400 border-dashed border-2 rounded-md'>
            ...
            <div className='flex flex-col items-start'>
              <h3 className='text-gray-700 text-xl font-bold'>File Pass</h3>
              <p className='text-gray-600'>Get 75% off up to INR 200 on all RuPay Card* on BookMyShow Stream</p>
            </div>
          </div>
        </div>
